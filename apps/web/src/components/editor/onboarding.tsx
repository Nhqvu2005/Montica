				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							<Title title="Welcome to Montica Beta! 🎉" />
							<Description description="You're among the first to try Montica - the fully open source CapCut alternative." />
						</div>
				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							...
							<Description description="If you're curious, check out our roadmap [here](https://montica.app/roadmap)" />
						</div>
						<NextButton onClick={handleNext}>Next</NextButton>
					</div>
				);
				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							<Title title={getStepTitle()} />
							<Description
								description={`Join our [Discord](${SOCIAL_LINKS.discord}), chat with cool people and share feedback to help make Montica the best editor ever.`}
							/>
						</div>
