...
Thank you for your interest in contributing to Montica! This document provides guidelines and instructions for contributing.
...
4. Configure required environment variables in `.env.local`:
   ...
   **Required Variables:**
   ...
   DATABASE_URL="postgresql://montica:montica@localhost:5432/montica"
